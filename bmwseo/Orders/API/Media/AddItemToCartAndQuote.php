...
function InsertIntoQuote($data) {
    global $pdo;
    try {     
        $stmt = $pdo->prepare("INSERT INTO quote_table VALUES (CURRENT_DATE, :PDOEntryUser, :PDOQuoteID, :PDOClientName, :PDOClientEmail, :PDOClientContact, :PDOClientGST, :PDOLeadDays, :PDOSource, '')");
