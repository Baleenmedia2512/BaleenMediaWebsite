...
$sql = "SELECT DISTINCT ConsultantName, ConsultantNumber FROM consultant_table WHERE ConsultantName LIKE :suggestion AND `Validity` = 1 LIMIT 5";
...
foreach ($vendors as $vendor) {
    $vendordetails = $vendor['ConsultantName'] . '(' . $vendor['ConsultantNumber'] . ')';
