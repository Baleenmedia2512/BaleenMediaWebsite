...
try{
  ...
  if ($conn ->connect_error){
    ...
    $sql = "SELECT (Payable - (SELECT COALESCE(sum(financial_transaction_table.Amount),0) from financial_transaction_table where OrderNumber = ".$orderNumber." and ValidStatus = 'Valid'  and TransactionType = 'Project Expense' )) as 'TotalAmount',VendorName from order_table where  OrderNumber = ".$orderNumber." and CancelFlag = 0";
    ...
    if ($result->num_rows > 0) {
      ...
      $Remarks = "Paid To ".$row["VendorName"];
