...
if(trim($_GET['suggestion']) !== '' && $DB == 'gracescans'){
    // Prepare the SQL statement to fetch client names based on the search term
    $sql = "SELECT DISTINCT ClientName, ClientContact FROM client_table WHERE ClientName LIKE :suggestion LIMIT 5";
